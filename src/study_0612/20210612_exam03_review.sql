...
select ename, substr(hiredate, 1, 2) as "입사 년도", substr(hiredate, 4, 2) as "입사 달"
from emp
;
...
select deptno as "부서번호",
        ...
        decode (deptno, 10, 'NEW YORK',
                                ...
                                30, 'CHICAGO',
                                40, 'BOSTON') as 지역명,
        count(*) as "사원 수", floor(avg(sal)) as "전체 평균 급여" -- 정수로 반올림
from emp
group by deptno
;
